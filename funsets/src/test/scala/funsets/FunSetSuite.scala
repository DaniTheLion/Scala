...
class FunSetSuite extends FunSuite {
  ...
  trait TestSets {
    ...
    val s4 = union(singletonSet(1),singletonSet(2)) //[1,2]
    val s5 = union(singletonSet(2),singletonSet(3)) //[2,3]
    val s6 = union(s5, singletonSet(4)) //[2,3,4]
  }
